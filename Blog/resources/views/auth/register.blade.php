                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">성별</label>

                            <div class="col-md-6">
                                <select name="sex" id="sex">
                                    <option value="femail">남자</option>
                                    <option value="mail">여자</option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('profile_image') ? ' has-error' : '' }}">
                            <label for="profile_image" class="col-md-4 control-label">프로필사진</label>
