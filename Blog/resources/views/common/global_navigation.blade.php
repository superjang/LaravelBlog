<nav class="nav__global">
    <ul>
        <li class="nav__link"><a href="{{ route('posts.index') }}" class="nav__link_text">About</a></li>
        ...
        <li class="nav__link nav__login_item--off">
            <a href="{{ route('users.show', ['id'=>Auth::user()->id]) }}" class="nav__link_text">{{ Auth::user()->name }}님</a>
        </li>
        @else
        <li class="nav__link nav__login_item--off">
            ...
            <div id="form__login">
                <form action="" method="post">
                    ...
                    <input type="text" id="user_id" class="field field__id" placeholder="아이디를 입력해 주세요."/>

                    <label for="user_password">비밀번호</label>
                    <input type="password" id="user_password" class="field field__password" placeholder="패스워드를 입력해 주세요."/>
